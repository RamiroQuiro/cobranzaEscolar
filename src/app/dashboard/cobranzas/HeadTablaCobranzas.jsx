  ...
  return (
    ...
    <tr>
      ...
      className="whitespace-nowrap pl-1 py-2 font-medium text-primary-800 cursor-pointer hover:bg-primary-300/20 duration-200">
         Comprobante<span className="duration-200"> {ordenarPor=="tipoComprobante" && "⬇️"}</span>
      </th>
      <th
      onClick={handleClick}
      ...
      <th 
       ...
       Legajo  <span className="duration-200"> {ordenarPor=="legajo" && "⬇️"}</span>
      </th>
      <th 
        onClick={handleClick}
        id="nombreLegajo"
        className="whitespace-nowrap px-4 py-2 font-medium text-primary-800 cursor-pointer  hover:bg-primary-300/20 duration-200">
        Nombre Alumno  <span className="duration-200"> {ordenarPor=="dniLegajo" && "⬇️"}</span>
      </th>
      <th 
        onClick={handleClick}
        id="fecha"
