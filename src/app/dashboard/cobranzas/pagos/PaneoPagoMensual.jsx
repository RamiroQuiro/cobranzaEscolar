  ...
  return (
    ...
    {periodos?.map((period,index)=>{
      ...
      return(
        <div
        key={index}
        className={`border border-primary-100/50 flex flex-col items-center justify-center rounded text-sm flex-grow ${isPay?.montoPagado?"bg-green-200/80":"bg-red-200/80"}`}
        >
