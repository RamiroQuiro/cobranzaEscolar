      ...
      <div className="w-full flex flex-col items-center justify-evenly ">
        ...
        >
          ...
          <div className="border-primary-200/50 flex-auto border flex items-center rounded-lg px-2 relative">
            <span className="absolute -top-5 left-4 bg-primary-200 rounded-lg font-medium p-1 text-xs">Descarga</span>
            <BotonEmoji
            id={"listadoPagosPDF"}
            onClick={(e)=>cargarPantalla(e.target.id)}
            >PDF</BotonEmoji>
            <BotonEmoji><span className="text-sm font-medium">Excel</span></BotonEmoji>
